...
ll num,q,arr[Mx],v1,v2,v3,ans,anss,cas=0;
...
//cout<<"SDS"<<ch<<"SDS"<<endl;
        ...
        if(ch==' ')
        {
            ...
            if(v1>v2)
            {
                ...
                update(1,0,num-1,v1,num-1,v3);
                update(1,0,num-1,0,v2,v3);
            }
            else
            {
                update(1,0,num-1,v1,v2,v3);
            }
        }
        else
        {
            if(v1>v2)
            {
                ans=query(1,0,num-1,v1,num-1);
                anss=query(1,0,num-1,0,v2);
             //   cout<<ans<<" "<<anss<<endl;
                ans=min(ans,anss);
